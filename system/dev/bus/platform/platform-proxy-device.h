...
public:
    ...
    zx_off_t DdkGetSize();
    zx_status_t DdkIoctl(uint32_t op, const void* in_buf, size_t in_len, void* out_buf, size_t out_len, size_t* actual);
...
private:
    ...
    // Extra fields for child devices.
    void* child_ctx_ = nullptr;
    zx_protocol_device_t* child_device_ops_ = nullptr;
    uint32_t child_proto_id_ = 0;
    void* child_proto_ops_ = nullptr;
};
