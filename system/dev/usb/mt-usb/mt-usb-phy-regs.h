...
public:
    ...
    DEF_BIT(1, chp_en);
    DEF_BIT(0, bgr_en);
    static auto Get() { return hwreg::RegisterAddr<USBPHYACR0>(0x800); }
};
...
public:public:
    ...
    static auto Get() { return hwreg::RegisterAddr<USBPHYACR1>(0x804); }
};
...
public:public:
    ...
    static auto Get() { return hwreg::RegisterAddr<USBPHYACR2>(0x808); }
};
...
public:public:
    ...
    DEF_FIELD(6, 4, ls_sr);
    DEF_FIELD(2, 0, fs_sr);
    static auto Get() { return hwreg::RegisterAddr<USBPHYACR4>(0x810); }
};
...
public:public:
    ...
    static auto Get() { return hwreg::RegisterAddr<USBPHYACR5>(0x814); }
};
...
public:public:
    ...
    DEF_FIELD(3, 0, sqth);
    static auto Get() { return hwreg::RegisterAddr<USBPHYACR6>(0x818); }
};
...
public:public:
    ...
    DEF_BIT(9, en_pu_dp);
    DEF_BIT(8, en_pd_dp);
    static auto Get() { return hwreg::RegisterAddr<U2PHYACR3>(0x81c); }
};
...
public:public:
    ...
    static auto Get() { return hwreg::RegisterAddr<U2PHYACR4>(0x820); }
};
...
public:public:
    ...
    static auto Get() { return hwreg::RegisterAddr<U2PHYDTM0>(0x868); }
};
...
public:public:
    ...
    static auto Get() { return hwreg::RegisterAddr<U2PHYDTM1>(0x86c); }
};
