...
$(BOARD_BOOTIMG): $(BOARD_ZIRCON_ZBOOTIMAGE_DTB)
	$(call BUILDECHO,generating $@)
	$(NOECHO)$(MKBOOTIMG) --kernel $< --kernel_offset $(PLATFORM_KERNEL_OFFSET) --base $(PLATFORM_MEMBASE) --tags_offset 0xE000000 --cmdline $(PLATFORM_CMDLINE) -o $@
...
$(BOARD_VBMETA): $(BOARD_BOOTIMG)
	$(call BUILDECHO,generating $@)	
	$(NOECHO)$(AVBTOOL) add_hash_footer --image $(BOARD_BOOTIMG) --partition_size $(PLATFORM_BOOT_PARTITION_SIZE) --partition_name boot 
	$(NOECHO)$(AVBTOOL) make_vbmeta_image --include_descriptors_from_image $(BOARD_BOOTIMG) --algorithm SHA512_RSA4096 --key $(AVB_KEY) --public_key_metadata $(AVB_PUBLIC_KEY_METADATA) --padding_size 4096 --output $@
